...
export class CreateWalletPage implements OnInit {
    ...
    constructor(
        ...
        this.derivationPathByDefault = this.derivationPathHelperProvider.getDerivationPathForCoin(this.coin, this.isShared);
        ...
        this.createForm = this.fb.group({
            ...
            totalCopayers: [1],
            requiredCopayers: [1],
            bwsURL: [this.coin === 'strat' ? this.defaults.sws.url : this.defaults.bws.url],
            selectedSeed: ['new'],
            recoveryPhrase: [null],
            derivationPath: [this.derivationPathByDefault],
            testnetEnabled: [this.coin === 'strat'], // Temporary for now
            singleAddress: [false],
